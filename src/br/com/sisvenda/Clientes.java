...
public class Clientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfPesquisaFornecedor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tfPesquisaFornecedorKeyReleased(evt);
            }
        });
...
alterarCliente();       
    ...
    private void tfPesquisaFornecedorKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfPesquisaFornecedorKeyReleased
      pesquisarUsuarios();  // TODO add your handling code here:
    }//GEN-LAST:event_tfPesquisaFornecedorKeyReleased
    ...
    protected boolean verificarUF(){
      ...
      protected void alterarCliente(){
        if (verificarCampos() && verificarUF()){
            ClienteBean fornecedor = new ClienteBean();
            fornecedor.setCodigo(clientes.get(tbClientes.getSelectedRow()).getCodigo());
    ...
    protected void desabilitarCampos(){
     ...
     protected void listarCliente(){
        ...
        clientes = cli.listarClientes("%" + tfPesquisaFornecedor.getText().trim() + "%");
